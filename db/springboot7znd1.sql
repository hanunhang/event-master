...
CREATE TABLE `announcement` (
    `annoucement_id` int NOT NULL AUTO_INCREMENT COMMENT '公告序号',
    `announcement_latitude` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '公告位置纬度',
    `announcemnet_longitude` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '公告位置经度',
    `announcement_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '公告内容',
    `announcement_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '公告照片',
    `announcement_date` timestamp NOT NULL COMMENT '公告日期',
...
INSERT INTO `announcement` VALUES (1,5.3592,100.294,'There is a robbery in the center park.','Null','2023-06-06 12:45:14'),(2,5.35538,100.293,'there is a head-on collision in the hostel sidewalk','Null','2023-06-01 12:45:18'),(3,5.35566,100.292,' there is a human trafficking in the hostel car park.','Null','2023-05-31 12:45:23'),(4,5.35566,100.292,' there is a human trafficking in the school car park.','Null','2023-05-31 18:45:23');
...
INSERT INTO `discussshequchangdi` VALUES (131,'2022-07-31 23:36:58',1,1,'用户名1','评论内容1','回复内容1'),(131,'2022-07-31 23:36:58',1,1,'用户名1','评论内容1','回复内容1'),(132,'2022-07-31 23:36:58',2,2,'用户名2','评论内容2','回复内容2'),(133,'2022-07-31 23:36:58',3,3,'用户名3','评论内容3','回复内容3'),(134,'2022-07-31 23:36:58',4,4,'用户名4','评论内容4','回复内容4'),(135,'2022-07-31 23:36:58',5,5,'用户名5','评论内容5','回复内容5'),(136,'2022-07-31 23:36:58',6,6,'用户名6','评论内容6','回复内容6');
